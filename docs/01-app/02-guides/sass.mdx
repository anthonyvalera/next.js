...
> **Note:** The `:exports` ICSS rule is not suppported by [Turbopack](/docs/app/api-reference/turbopack#unsupported-and-unplanned-features). If you have enabled Turbopack in your Next.js project with the `--turbopack` flag in your `package.json`, you will need to remove it to use `:exports`.
